...
public class QueueConnectionPool implements ConnectionPool {
    ...
    /**
     * 1) Нет ограничение на кол-во конектов сверху. При нагрузке можно съесть все доступные ресурсы
     * 2) Если конект какое-то время не используется, то его нужно отпускать (idle time)
     */
    @Override
